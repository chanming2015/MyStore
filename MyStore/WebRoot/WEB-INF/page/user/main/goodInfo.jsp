...
<!--[if IE 6]>
        ...
        <script type="text/javascript">
        	...
        	function add() {
				$("#goodsId").val(${goodsIamge.goods.gId});
				$("#add").submit();
			}
        </script>
</head>
<body>
	...
	<div style="margin-top:185px;">
		...
		<div class="mobile-upload-entry " id="mobile-upload-entry"
			...
			<span class="close-btn"></span> <span class="erweima detail"> </span></span>
		</div>
		...
		<div class="p-bread-crumb" mon="deal_id=1472205"
			...
			<div class="p-item-info" mon="deal_id=1472205">
				<div class="w-item-info clearfix">
					<h2>${goodsIamge.goods.gName }</h2>
					<div class="item-title">
						${goodsIamge.goods.gName }只卖${goodsIamge.goods.gMoney }啦！！<span class="hot hide"></span>
					</div>
					<div class="ii-images clearfix">
						<div class="w-item-images">

							<div id="j-images-board" class="images-board">
								<c:if test="${goodsIamge.imagePathList.size()!=0 }">
									<img class="Divimg" width="220" height="220" src="/${projectName }/img/user/${goodsIamge.imagePathList.get(0)}"/>
									<!--<img width="220" height="220" alt="" src="/${projectName}/img/user/${goodsIamgeList.imagePathList.get(0)}"/>  -->
								</c:if>
								<c:if test="${goodsIamge.imagePathList.size()==0 }">
									<img class="Divimg" width="220" height="220" alt="" src="/${projectName}/img/user/div1.jpg"/>
								</c:if>
							</div>
						...
						<div class="w-item-intro">
							...
							<div class="price-area clearfix">
								<div class="match-price-area">
									<span class="unit">&yen;</span>${goodsIamge.goods.gMoney }
								</div>
								<div class="market-price-area">
									<div class="price">&yen;${fn:split(goodsIamge.goods.gMoney*100/84+"", ".")[0]}</div>
							...
							<div class="validdate-buycount-area">
								...
								<div class="item-buycount-row j-item-buycount-row clearfix"
									...
									<div class="y-stock">本商品还剩
									<b class="num">${stock.sNum }</b>件,抓紧购买吧^_^!
									</div>
									</c:if>
									<c:if test="${stock==null}">
									<div class="n-stock">不好意思，本商品已经缺货，<a class="t-stock" href="/${projectName}">重新选购其他商品？</a></div>
									</c:if>
					...
					<div class="s-imges">
						<ul>
							<c:forEach items="${goodsIamge.imagePathList}" var="goodsimg">
							<li class="i-li"><img class="img-size" src="/${projectName }/img/user/${goodsimg}"/></li>
							</c:forEach>
			...
			<div class="p-item-info-more" mon="deal_id=1472205">
				<div class="iim-wrapper clearfix">
					<div class="info-detail">
						...
						<div class="gg-div">
							<ul>
								<li><div><img class="gg-img" src="/${projectName }/img/user/div1.jpg"/></div>
									<div class="gg-biaoti"><span>变超人的短裤</span></div>
								</li>
								<li><div><img class="gg-img" src="/${projectName }/img/user/div2.jpg"/></div>
									<div class="gg-biaoti"><span>变超人的短裤</span></div>
								</li>
								<li><div><img class="gg-img" src="/${projectName }/img/user/div3.jpg"/></div>
									<div class="gg-biaoti"><span>变超人的短裤</span></div>
								</li>
								<li><div><img class="gg-img" src="/${projectName }/img/user/div4.jpg"/></div>
									<div class="gg-biaoti"><span>变超人的短裤</span></div>
								</li>
								<li><div><img class="gg-img" src="/${projectName }/img/user/div5.jpg"/></div>
									<div class="gg-biaoti"><span>变超人的短裤</span></div>
								</li>
								<li><div><img class="gg-img" src="/${projectName }/img/user/div6.jpg"/></div>
									<div class="gg-biaoti"><span>变超人的短裤</span></div>
								</li>
								<li><div><img class="gg-img" src="/${projectName }/img/user/div7.jpg"/></div>
									<div class="gg-biaoti"><span>变超人的短裤</span></div>
								</li>
								<li><div><img class="gg-img" src="/${projectName }/img/user/div8.jpg"/></div>
									<div class="gg-biaoti"><span>变超人的短裤</span></div>
								</li>
								<li><div><img class="gg-img" src="/${projectName }/img/user/div9.jpg"/></div>
									<div class="gg-biaoti"><span>变超人的短裤</span></div>
								</li>
							</ul>
						</div>
									...
									<div class="info-buy-content">
										<div class="w-rich-text">
											...
											<div class="rt-content">
												<p class='wrap-img'>
												<c:forEach items="${goodsIamge.imagePathList}" var="goodsimg">
													<img src="/${projectName }/img/user/${goodsimg}"
									...
									<div class="w-user-comment" id="j-user-comment">
										...
										<div class="detail clearfix">
											...
											<div class="status">
												...
												<a class="button" href="/${projectName }/UserLogined/LoginedDiscussServlet?op=tocomments&goodsId=${goods.gId}" id="j-add-comment">我要评价</a>
											</div>
										</div>
										...
										<input type="hidden" name="op" value="showinfo"/>
										<input type="hidden" name="goodsId" value="${goodsId }">
										<c:forEach items="${pageBean.dataList }" var="dlist">
									<div class="plDiv">
										<div class="bigDiv">
