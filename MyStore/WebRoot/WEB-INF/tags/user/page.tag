...
<%@ attribute name="pageBean" required="true" type="com.dyr.entity.PageBean" description="分页实体对象"%>
<div class="page">
	<script type="text/javascript">
		...
		function jumpPage(page, rows) {
			...
			var pagesCount=${pageBean.pagesCount};
			...
			$("form[name='${form}']")[0].page.value=pageNum;
